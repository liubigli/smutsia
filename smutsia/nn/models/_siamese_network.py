...
from ..loss.ultrametric_loss import make_triplets
...
class SiameseUltrametric(pl.LightningModule):
    def __init__(self, in_channels: int, hidden_features: int, k: int, transformer: bool = False,
                 loss: str = 'closest+triplet', margin: float = 1.0, gamma: float = 1.0,
                 plot_interval: int = -1):
        ...
        self.loss_triplet = losses.TripletMarginLoss(margin=self.margin)
